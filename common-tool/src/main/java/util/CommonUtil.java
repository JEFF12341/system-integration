...
public class CommonUtil {
	...
	public static boolean isPreEnvironment() {
		...
		if (StringUtil.isNotBlank(environment) && (environment.indexOf(ENVIRONMENT_PRE) != -1 || environment.indexOf(ENVIRONMENT_PRE.toUpperCase()) != -1)) {
			return true;
		} else {
			return false;
		}
	...
	public static boolean isGrayEnvironment() {
		...
		if (StringUtil.isNotBlank(environment) && (environment.indexOf(ENVIRONMENT_GRAY) != -1 || environment.indexOf(ENVIRONMENT_GRAY.toUpperCase()) != -1)) {
			return true;
		} else {
			return false;
		}
